...
# 爬取数据
url = 'https://api.xiaoheihe.cn/wiki/get_article_for_app/?article_id=2636283&wiki_id=1000000020&is_share=1'
...
for idx, line in enumerate(lines):
    ...
    # if line_dict.get('img_path')[-7:-5] == '部1':
    #     print()
    part = line_dict.pop('img_path').split('/')[-1][0:2]
    line_dict['part'] = part
    data_lst += [line_dict]
df = pd.DataFrame(data_lst)
df.to_excel('..//data//56.怪猎防具冰原.xlsx')
